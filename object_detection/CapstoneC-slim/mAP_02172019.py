...
def Load_GroundTruthFiles(tmp_files_path):
    """
     Ground-Truth
...
def Load_PredictionFiles(predicted, gt_classes, groundtruth,  tmp_files_path):
    """
     Predicted
...
def aP_and_mAP_Calculation(gt_classes, gt_counter_per_class, n_classes,  results_files_path ,  tmp_files_path):
...
predictedfolders = ['faster_rcnn_inception_v2_coco','faster_rcnn_resnet50_coco','mask_rcnn_inception_v2_coco', 'rfcn_resnet101_coco', 'ssd_inception_v2_coco']


def run(n, predictedfolders, path):
    ...
    tmp_files_path,results_files_path =tempFiles(predictedfolders[n], path)
    #print( tmp_files_path,results_files_path)

    gt_counter_per_class, ground_truth_files_list =Load_GroundTruthFiles(tmp_files_path)
    ...
    predicted_files_list =Load_PredictionFiles(predicted,  gt_classes, groundtruth,  tmp_files_path)
    count_true_positives, mAP, ap_dictionary=aP_and_mAP_Calculation(gt_classes, gt_counter_per_class,  n_classes, results_files_path , tmp_files_path )
